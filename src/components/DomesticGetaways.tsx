...
export function DomesticGetaways() {
  ...
  return (
    <section id="domestic" className="py-16 md:py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="text-center mb-8 md:mb-10">
          <h2 className="font-heading text-3xl md:text-5xl text-gray-900 mb-3">
            <span className="italic font-serif font-medium text-gray-700">Domestic</span> <span className="font-bold">Getaways</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {domesticGetaways.map((trip, index) => (
            <motion.div
              key={trip.id}
            ...
            >
              <Link to={`/package/dom-${trip.id}`} className="flex flex-col flex-grow">
